...
function IndonesiaOnline() {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbzfF3Mc3xuuAgITM4uQskVGwTkwg1UGNUcyPSDz1Ar1NyS7SClNuWdStHi_AKMWbqZN0A/exec";
      ...
      <section className="registration-section">
        <div class="container">
          <div class="content">
            ...
            <br />
            <h4>
              HALLO PESERTA WSEEC 2025, Mohon perhatikan informasi berikut ini
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="INFORMATION_RESOURCES" className="form-label">
                    Sumber Informasi Kompetisi WSEEC 2025
                  </label>
                  <select
                    type="text"
