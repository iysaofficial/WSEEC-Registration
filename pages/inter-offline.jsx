        ...
        if (buttonCounter === 0) {
          ...
          try {
            ...
            if (response.ok) {
              ...
              setTimeout(() => {
                window.location.href = "/thankyouinterpage"; // Redirect setelah 1 detik
              }, 1000);
            } else {
      ...
      <section className="registration-section">
        <div class="container">
          <div class="content">
            ...
            <br />
            <h4>
              HELLO WSEEC 2025 PARTICIPANTS, Please consider the following
                ...
                <div class="input-box">
                  ...
                  >
                    ...
                    {/* <option value="Online Competition + Certificate and Medal">
                       Competition + Certificate and Medal
                    </option> */}
                  </select>
                </div>
              </div>
              ...
              <div className="user-details">
                ...
                <div class="input-box">
                  <label for="INFORMATION_RESOURCES" class="form-label">
                    WSEEC 2025 Competition Information Resources
                  </label>
                  <select
                    type="text"
