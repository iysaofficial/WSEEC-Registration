...
export default function InternationalOnline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "World Science, Environment and Engineering Competition - Online Competition":
        setCategoryPrice("$105 USD");
        break;
      case "World Science, Environment and Engineering Competition - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)":
        setCategoryPrice("$225 USD");
        break;
      case "World Science, Environment and Engineering Competition - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)":
  ...
  const scriptURL = "https://script.google.com/macros/s/AKfycbzOUPlL9U3YngMPHK2PnH5vCcIkg0wzp1ZHuLrVYbch0g3gbxqxkFQgedpxQtMV1UDFUg/exec";
      ...
      <section className="registration-section">
        <div class="container">
          <div class="content">
            ...
            <br />
            <h4>
              HELLO WSEEC 2026 PARTICIPANTS, Please consider the following
              ...
              <div class="user-details">
                ...
                <div class="input-box">
                  ...
                  >
                    ...
                    <option value="World Science, Environment and Engineering Competition - Online Competition">
                      Online Competition
                    </option>
                    <option value="World Science, Environment and Engineering Competition - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)">
                      Online Competition + Certificate and Medal (SOUTH EAST
                      ASIA)
                    </option>
                    <option value="World Science, Environment and Engineering Competition - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="Energy and Engineering">Energy and Engineering</option>
                  </select>
                </div>
                <div class="input-box">
              ...
              <div className="user-details">
                ...
                <div class="input-box">
                  <label for="INFORMATION_RESOURCES" class="form-label">
                    WSEEC 2026 Competition Information Resources
                  </label>
                  <select
                    type="text"
                  ...
                  >
                    ...
                    <option value="WSEEC Instagram">WSEEC Instagram</option>
